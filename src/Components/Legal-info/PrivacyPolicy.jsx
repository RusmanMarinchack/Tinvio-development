...
export default function LegalInfo() {
    return(
        <div className="legal-info__body legal-info-body">
                        <div className="legal-info-body__item">
                            <p>Digital Services SG Six Pte. Ltd. ("Tinvio"), a company incorporated in Singapore, understands how important the privacy of personal information is to our users. At Tinvio, we want to make your experience satisfying and safe. This statement governs information you provide to us or we learn from your using or visiting any websites and applications owned and/or operated by Tinvio and any and all services provided to you by Tinvio (collectively, "Services"). Please read the following to learn more about our Privacy Policy (the "Policy"). The term "you" or "your" generally refers to the individual reading this Policy and/or using the Service.
                            In order to preserve your trust, we want you to understand what information we may collect from you, how we use such information, and the choices you have regarding our use of this information. This Policy explains how Tinvio and some of the companies we work with collect, use, share and protect information in relation to the Services.</p>
                        </div>
                        <div className="legal-info-body__item">
                            <h5>What does this Privacy Policy Cover?</h5>
                            <p>This Policy applies to all users and others who access the Services ("Users") in or outside Singapore. By accessing or using the Service, or providing information to us in connection with the Services, you expressly and unequivocally indicate your acceptance of Tinvio's Privacy Policy.
                            This Privacy Policy does not apply to the practices, policies, or procedures employed by third parties and/or entities that Tinvio does not own, manage or control, or to individuals and others whom Tinvio does not employ, contract, manage, or control.</p>
                        </div>
                        <div className="legal-info-body__item">
                            <h5>What does this Privacy Policy Cover?</h5>
                            <p>Depending on your user profile, Tinvio collects some or all of the following types of information:</p>
                            <ul>
                        ...
                        <div className="legal-info-body__item">
                            ...
                            <p>The Services are hosted in Singapore. If you are visiting from the United States, European Union or other regions with laws governing data collection and use that may differ from Singapore law, please note that you are transferring your personal data to Singapore which does not have the same data protection laws as the United States or EU or other regions and by providing your personal data you consent to: THE USE OF YOUR PERSONAL DATA FOR THE USES IDENTIFIED ABOVE IN ACCORDANCE WITH THIS PRIVACY POLICY; AND THE TRANSFER OF YOUR PERSONAL DATA TO SINGAPORE AS INDICATED ABOVE.
                            We use commercially reasonable safeguards to help keep the information collected through the Service secure. However, Tinvio cannot ensure the security of any information you transmit to Tinvio or guarantee that information on the Service may not be accessed, disclosed, altered, or destroyed.</p>
                        </div>
                        <div className="legal-info-body__item">
                        ...
                        <div className="legal-info-body__item">
                            ...
                            <p>Upon request, Tinvio will provide you with information about whether we hold, or process on behalf of a third party, any of your personal information. To request this information please e-mail us at privacy@tinvio.com.
                            If your personal information changes, or if you no longer desire our service, you may correct, update, delete/remove, or ask to have it removed from a public forum or testimonial by making the change within your account settings or by contacting us via one of the methods listed in this Policy. Please note that copies of information that you have updated, modified, or deleted may continue to reside in our systems for a period of time. Also, you may not be able to remove your personal information from archived web pages that we no longer maintain. In the event we are unable to complete your access request, we will let you know if we are unable to do so and why. We may decline to process requests that are unreasonably repetitive, require disproportionate technical effort, jeopardise the privacy of others, are extremely impractical, or for which access is not otherwise required by local law.
